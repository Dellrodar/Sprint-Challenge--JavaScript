...
graduates.forEach((arrItem => {contactInfo.push(`${arrItem.first_name} ${arrItem.email}`)}))
...
*/
const displayNames = [];
zooAnimals.forEach(arrItem => {displayNames.push(`Name: ${arrItem.animal_name} Scientific: ${arrItem.scientific_name}.`)})
